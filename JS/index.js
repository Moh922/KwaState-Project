...
function scrollHeader() {
    ...
    // when the scroll is greater that 50 viewport Height, add 
...
// We obtain the current theme that the Interface has by validating the dark-theme vlass
...
if(selectedTheme) {
  ...
  themeButton.classList[selectedIcon === 'bx bx-icon' ? 'add' : 'remove'](iconTheme)
}

// Activate / deactivate the theme manually withe the button
themeButton.addEventListener('click', ()=>{
  document.body.classList.toggle(darkTheme)
  themeButton.classList.toggle(iconTheme)
  //We save the theme and the curent icon the user chose
...
sr.reveal('.value-content, .contact-images', {delay: 900, origin: 'right'})